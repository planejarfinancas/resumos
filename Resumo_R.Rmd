...
Chamando a referencia @Simpson para teste
Largura: fig.width
Altura: fig.height
Inserir legenda: fig.cap
Alinhamento: fig.align; ‘left’, ‘center’ou ’right’
Tamanho da figura com relação a página do documento:
% de largura da página: out.width
% de comprimento da página: out.height
